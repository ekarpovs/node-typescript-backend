...
<p>
  <a href="https://github.com/ekarpovs/node-typescript-backend/actions/workflows/ci-build.yaml" target="_blank">
    <img alt="CI build" src="https://github.com/ekarpovs/node-typescript-backend/actions/workflows/ci-build.yaml/badge.svg?branch=main" />
  </a>
  <a href="https://github.com/ekarpovs/node-typescript-backend#readme" target="_blank">
    <img alt="Documentation" src="https://img.shields.io/badge/documentation-yes-brightgreen.svg" />
  </a>
  <a href="https://github.com/ekarpovs/node-typescript-backend/graphs/commit-activity" target="_blank">
    <img alt="Maintenance" src="https://img.shields.io/badge/Maintained%3F-yes-green.svg" />
  </a>
  <a href="https://github.com/ekarpovs/node-typescript-backend/blob/master/LICENSE" target="_blank">
    <img alt="License: MIT" src="https://img.shields.io/badge/License-MIT-yellow.svg" />
  </a>
</p>

backend starter for nodejs typescript projects.  
Based on the project created with the [online CLI](https://bitjson.github.io/typescript-backend/).  
...
```bash
git clone https://github.com/ekarpovs/node-typescript-backend.git .
rm -r .git
git init
